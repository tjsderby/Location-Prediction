...
def batchGen(batchSize, sequenceLength):
    ...
    while True:
        ...
        for i in range(batchSize):
            # finds a random index number to select from training data
...
# avg daily records times 1.5
sequenceLength = int(493 * 1.5) # amount of time steps the random batch will be
...
model.add(LSTM(units=256, return_sequences=True, input_shape=(None, numSignalsX,))) # adding 256 output signals
